...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_update_user_returns_error(self):
        """Test changing the recipe user results to an error."""
        new_user = create_user(
            email='new-user@example.ccom',
            password='sample123',
        )
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        ...
        new_suer = create_user(
            email='new-user@example.com',
            password='testpass123',
        )
        recipe = create_recipe(user=new_suer)
    ...
    def test_update_recipe_assign_exisitng_tag(self):
        """Test assigining existing tag when updating a recipe."""
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating recipe with exisiting ingredient."""
